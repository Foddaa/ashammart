            ...
            <table className="table table-hover table-bordered align-middle mb-0">
              <thead className="bg-light">
                <tr>
                  ...
                  <th className="py-3 px-4 text-secondary fw-medium text-center">الشركة</th>
                  <th className="py-3 px-4 text-secondary fw-medium text-center">الايميل</th>
                  <th className="py-3 px-4 text-secondary fw-medium text-center">الهاتف</th>
                ...
                {filteredSuppliers.length > 0 ? (
                  filteredSuppliers.map((sup) => (
                    <tr key={sup.id}>
                      ...
                      <td className="px-4 text-center">{sup.company}</td>
                      <td className="px-4 text-center">{sup.email}</td>
                      <td className="px-4 text-center">{sup.phone}</td>
