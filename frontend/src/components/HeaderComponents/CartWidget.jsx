...
const { Token,setToken,userRole,setUserRole } = useContext(UserContext);
  ...
  return (
    ...
    <button className="cursor-pointer w-[30px] h-[30px] sm:w-[20px] sm:h-[20px] md:w-[42px] md:h-[42px] bg-[#fff1ee] rounded-full flex items-center justify-center relative" onClick={navigateToCart}>
